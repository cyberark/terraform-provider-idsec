		...
		Resources: []*tfactions.IdsecServiceTerraformResourceActionDefinition{
			{
				...
				SupportedOperations: []tfactions.IdsecServiceActionOperation{tfactions.CreateOperation, tfactions.UpdateOperation, tfactions.ReadOperation, tfactions.DeleteOperation, tfactions.StateOperation},
				ActionsMappings:     map[tfactions.IdsecServiceActionOperation]string{tfactions.CreateOperation: "create", tfactions.UpdateOperation: "update", tfactions.ReadOperation: "get", tfactions.DeleteOperation: "delete"},
				ImportID:            "app_id",
			},
			{
				IdsecServiceBaseTerraformActionDefinition: tfactions.IdsecServiceBaseTerraformActionDefinition{
				...
				SupportedOperations: []tfactions.IdsecServiceActionOperation{tfactions.CreateOperation, tfactions.UpdateOperation, tfactions.ReadOperation, tfactions.DeleteOperation, tfactions.StateOperation},
				ActionsMappings:     map[tfactions.IdsecServiceActionOperation]string{tfactions.CreateOperation: "create-auth-method", tfactions.UpdateOperation: "update-auth-method", tfactions.ReadOperation: "get-auth-method", tfactions.DeleteOperation: "delete-auth-method"},
