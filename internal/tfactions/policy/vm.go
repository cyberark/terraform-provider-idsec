...
import (
	"github.com/cyberark/idsec-sdk-golang/pkg/services/policy/vm/actions"
		...
		Resources: []*tfactions.IdsecServiceTerraformResourceActionDefinition{
			{
				IdsecServiceBaseTerraformActionDefinition: tfactions.IdsecServiceBaseTerraformActionDefinition{
					IdsecServiceBaseActionDefinition: tfactions.IdsecServiceBaseActionDefinition{
						ActionName: "policy-vm", ActionDescription: "Infrastructure Virtual Machine (VM) policy resource.", ActionVersion: 1, Schemas: actions.ActionToSchemaMap,
					},
		...
		DataSources: []*tfactions.IdsecServiceTerraformDataSourceActionDefinition{
			{
				IdsecServiceBaseTerraformActionDefinition: tfactions.IdsecServiceBaseTerraformActionDefinition{
					IdsecServiceBaseActionDefinition: tfactions.IdsecServiceBaseActionDefinition{
						ActionName: "policy-vm", ActionDescription: "Infrastructure Virtual Machine (VM) policy data source.", ActionVersion: 1, Schemas: actions.ActionToSchemaMap,
					},
					StateSchema: &policyvmmodels.IdsecPolicyVMAccessPolicy{},
				},
