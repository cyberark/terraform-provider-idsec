...
This workflow describes how to install a SIA connector using the Idsec Terraform Provider. The SIA connector enables secure access to target machines as part of the Idira Identity Security Platform.
