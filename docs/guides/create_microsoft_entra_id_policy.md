...
variable "workspace_id" {
  description = "The ID given to the Microsoft Entra ID workspace when it was onboarded to Idira. Required."
  type        = string
}
variable "org_id" {
...
variable "workspace_type" {
  description = "The level at which the Microsoft Entra ID workspace was onboarded to Idira. Allowed values: Directory, Management Group, Subscription, Resource Group, Resource."
  type        = string
}
