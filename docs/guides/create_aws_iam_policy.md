...
resource "idsec_policy_cloud_access" "example_aws_iam_policy" {
  ...
  targets = {
    aws_account_targets = [
      {
        role_id      = "arn:aws:iam::123456789123:role/examplerole" # var.role_id
  ...
  principals = [
    {
      ...
      source_directory_id   = "95B8A9B0-6DE8-465F-AB03-65766D33B05U" #var.principal_source_directory_id
