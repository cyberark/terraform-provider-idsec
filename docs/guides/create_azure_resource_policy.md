...
3. Create an Azure resource for access to resources in the Microsoft Entra ID directory
...
resource "idsec_policy_cloud_access" "example_azure_resource_policy" {
  ...
  targets = {
    azure_targets = [
      {
      role_id        = "/subscriptions/19b70f3f-b121-46bd-a942-7966beb1669d/providers/Microsoft.Authorization/roleDefinitions/8d6517c1-e434-405c-9f3f-e0ae65085d76" #var.role_id
      workspace_id   = "subscriptions/19b70f3f-b121-46bd-a942-7966beb1669d" #var.workspace_id
      org_id         = "2ca55f05-abc1-12f3-9f0b-6b3f65b8d100" #var.org_id
      workspace_type = "subscription" #var.workspace_type
      },
      {
        role_id        = "/subscriptions/19b70f3f-b121-46bd-a942-7966beb1669d/providers/Microsoft.Authorization/roleDefinitions/11076f67-66f6-4be0-8f6b-f0609fd05cc9"
        workspace_id   = "subscriptions/19b70f3f-b121-46bd-a942-7966beb1669d"
        org_id         = "2ca55f05-abc1-12f3-9f0b-6b3f65b8d100"
...
variable "policy_tags" {
  description = "Customized tags to help identify the policy and those similar to it - maximum 20 tags per policy. (e.g. ['test_azure_resource'])"
  type        = list(string)
  default     = []
  validation {
...
variable "role_id" {
  description = "The identifier of the Azure resource role or Entra ID role. Required."
  type        = string
}
...
variable "org_id" {
  description = "Azure directory ID (UUID). Required."
  type        = string
}
