---
page_title: "Create access control policy for Azure resource - management group level"
description: |-
...
resource "idsec_policy_cloud_access" "example_azure_resource_management_group_policy" {
  ...
  targets = {
    azure_targets = [
      {
      role_id        = "/providers/Microsoft.Authorization/roleDefinitions/7f951dda-9ed3-0000-a5ca-43fe172d538d" #var.role_id
      workspace_id   = "providers/Microsoft.Management/managementGroups/7ca66f05-abc6-50f5-9f0b-6b3f65b8d1a5" #var.workspace_id
      org_id         = "7ca66f05-abc6-50f5-9f0b-6b3f65b8d1a5" #var.org_id
      workspace_type = "management_group" #var.workspace_type
      }
    ]
  }
  principals = [
