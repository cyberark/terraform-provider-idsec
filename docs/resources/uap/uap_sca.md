...
description: Cloud console access policy resource; Enables creating, viewing,editing, and deleting access policies to cloud services. For more information about the schema parameters, see the <a href='https://api-docs.cyberark.com/uap-schema-api/docs/access-control-policies-api' target='_blank'>Access Control Policies API</a> documentation.
---

# idsec_uap_sca (Resource)

Cloud console access policy resource; Enables creating, viewing,editing, and deleting access policies to cloud services. For more information about the schema parameters, see the <a href='https://api-docs.cyberark.com/uap-schema-api/docs/access-control-policies-api' target='_blank'>Access Control Policies API</a> documentation.
