...
description: Privilege Cloud target platform data source, reads target platform information and metadata, based on the platform ID.
---

# idsec_pcloud_target_platform (Data Source)

Privilege Cloud target platform data source, reads target platform information and metadata, based on the platform ID.
